...
- [~] 1.1 Re-grep this package for `toIso8601String` and confirm the 7 serialization sites and which 3 already carry `.toUtc()`: `character_entities.dart:181-182,231-232`, `worldbook_entities.dart:112-113` (UTC) vs `prompt_profile.dart:96-97`, `prompt_manager.dart:893-894`, `regex_profile.dart:132-133`, `regex_script.dart:255-256` (not)
- [ ] 1.2 Re-confirm the construction sites feeding the non-UTC serializers: `prompt_profile.dart:44,47`, `prompt_manager.dart:855-856`, `regex_profile.dart:91,94`, `regex_script.dart:120,123` — all bare `DateTime.now()`, i.e. local
...
- [ ] 1.4 Record the baseline: `dart analyze` clean, `dart test` at 177 cases, `dart format --set-exit-if-changed .` clean
...
- [ ] 3.1 Normalize to UTC at `prompt_profile.dart:96-97`
- [ ] 3.2 Normalize to UTC at `prompt_manager.dart:893-894`
- [ ] 3.3 Normalize to UTC at `regex_profile.dart:132-133`
- [ ] 3.4 Normalize to UTC at `regex_script.dart:255-256`
...
- [ ] 3.6 Confirm the section-2 tests now pass and all 177 existing cases stay green
